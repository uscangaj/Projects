...
public class CamerasSensors_device_list extends AppCompatActivity {
    //variables
    ...
    private void createList() {
        ...
        Category point = Category.all_categories[2];
        ...
        for (int i = 0; i < point.sizeSub(); i++) {
            ...
            switch (connection) {
                ...
                default:    wifi = R.drawable.wifi_green; break;
            }
...
//
//        Intent newIntent = new Intent(CamerasSensors_device_list.this, Popup_device_info.class);
//
