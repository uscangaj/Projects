...
public class Misc_device_list extends AppCompatActivity {
    //variables
    ...
    private void createList() {
        ...
        Category point = Category.all_categories[3];
...
//
//        Intent newIntent = new Intent(Misc_device_list.this, Popup_device_info.class);
//
