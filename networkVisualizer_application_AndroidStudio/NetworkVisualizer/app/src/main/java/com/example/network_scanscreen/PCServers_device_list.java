...
public class PCServers_device_list extends AppCompatActivity {
    //variables
    ...
    private void createList() {
        ...
        Category point = Category.all_categories[1];
...
//
//        Intent newIntent = new Intent(PCServers_device_list.this, Popup_device_info.class);
//
//
