...
public class PhonesTablets_device_list extends AppCompatActivity {
    //variables
    ...
    private void createList() {
        ...
        Category point = Category.all_categories[0];
...
//
//        Intent newIntent = new Intent(PhonesTablets_device_list.this, Popup_device_info.class);
//
